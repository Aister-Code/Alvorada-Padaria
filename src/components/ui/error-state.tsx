...
function ErrorStateHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
...
const errorStateMediaVariants = cva(
  "flex shrink-0 items-center justify-center mb-2 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-transparent text-destructive [&_svg:not([class*='size-'])]:size-12",
...
function ErrorStateDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
