...
export default function ConversationDetail({
  ...
  if (!conversation) {
    return (
      <section className="flex h-full min-h-0 flex-col items-center justify-center rounded-2xl bg-white px-6 text-center text-[#685c20] dark:bg-[#151513] dark:text-[#f3c4a2]">
  ...
  return (
    <section className="flex h-full min-h-0 flex-col rounded-2xl bg-white text-[#1f1f1a] dark:bg-[#151513] dark:text-[#f7f2ec]">
      ...
      <div className="mx-3 mb-2 rounded-2xl bg-[#1f1f1a]/7 px-3 py-2 dark:bg-[#f3c4a2]/7">
      ...
      <div className="shrink-0 space-y-2 px-3 pb-3">
        <div className="grid grid-cols-3 gap-2">
          <button
            type="button"
            onClick={onAssume}
            className="flex cursor-pointer items-center justify-center gap-1.5 rounded-xl bg-[#685c20]/8 px-2 py-2 text-[11px] font-semibold hover:bg-[#685c20]/12 dark:bg-[#f7f2ec]/8 dark:hover:bg-[#f3c4a2]/12"
          >
          ...
          <button
            type="button"
            onClick={onMarkRead}
            className="cursor-pointer rounded-xl bg-[#685c20]/8 px-2 py-2 text-[11px] font-semibold hover:bg-[#685c20]/12 dark:bg-[#f7f2ec]/8 dark:hover:bg-[#f3c4a2]/12"
          >
            Lida
          </button>
          <button
