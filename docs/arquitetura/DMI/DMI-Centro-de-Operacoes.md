# DMI — Centro de Operações

## Objetivo

Ser o ponto inicial, final e de retomada de toda operação.

## Perfil Principal

Gerente e perfis com centro operacional autorizado.

## Tipo de Tela

Workspace Operacional Adaptativo.
...
- ISO.
- Escala Operacional.
- Configuração contextual de widgets.
...
Módulos e widgets respeitam perfil base, modo operacional atual e unidade atual.
...
Widgets, módulos premium, atalhos por perfil e indicadores avançados.
...
Controle, velocidade, silêncio visual e leitura em menos de 5 segundos.
