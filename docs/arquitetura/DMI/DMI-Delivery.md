...
Conduzir entregas, registrar rota e comunicar ocorrências.
...
- Transferir para Atendimento/Caixa/Gerente

## Regras de Permissões

Delivery não recebe pagamento salvo política explícita futura.
...
Mapa, rastreio, motoboy, taxa dinâmica e integração de rota.

## Nível de Implantação

Obrigatório para entrega / Fase 2
...
Movimento, clareza e responsabilidade.
