# DMI — Usuários/Administração

## Objetivo

Gerenciar operadores, acessos, permissões e suporte administrativo.

## Perfil Principal

Gerente, Administração e Superadmin.
...
Somente perfis autorizados podem alterar acesso. Toda alteração deve ser auditada.
...
Perfis avançados, auditoria detalhada, políticas por unidade e suporte externo.

## Nível de Implantação

Obrigatório administrativo / Fase 1
...
Segurança, clareza e responsabilidade.
