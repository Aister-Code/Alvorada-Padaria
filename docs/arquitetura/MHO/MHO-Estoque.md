...
Confirmar que Estoque respeita a operação real, a herança do RondonIA OS e o DMI do módulo.
...
- Nível de implantação: Opcional avançado / Fase 3.
- Nível de maturidade: Intermediária a Avançada.
