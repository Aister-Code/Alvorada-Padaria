...
Confirmar que Gestão respeita a operação real, a herança do RondonIA OS e o DMI do módulo.
...
- Nível de implantação: Opcional/Premium / Fase 4.
- Nível de maturidade: Avançada.
