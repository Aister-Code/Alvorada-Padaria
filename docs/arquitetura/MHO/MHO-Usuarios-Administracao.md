# MHO — Usuários/Administração

## Objetivo da Homologação

Confirmar que Usuários/Administração respeita a operação real, a herança do RondonIA OS e o DMI do módulo.
...
- Nível de implantação: Obrigatório administrativo / Fase 1.
