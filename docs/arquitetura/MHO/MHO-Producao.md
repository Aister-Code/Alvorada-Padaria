...
Confirmar que Produção respeita a operação real, a herança do RondonIA OS e o DMI do módulo.
...
- Nível de implantação: Obrigatório para operação com cozinha / Fase 2.
